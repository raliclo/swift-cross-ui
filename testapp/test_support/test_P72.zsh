...
export TEST_SUMMARY_PATTERN="RENDER COMPLETE|SCROLL|SNAPSHOT|EXPORTED|EXPORT FAILED|AUTO SPIN|STOPPED at frame|CHECK at frame|mesh view supported|NO FRAME CLOCK|backend"
