...
export TEST_SUMMARY_PATTERN="RENDER COMPLETE|KEY |MODIFIERS|SCROLL|SNAPSHOT|EXPORTED|EXPORT FAILED|AUTO SPIN|STOPPED at frame|CHECK at frame|mesh view supported|NO FRAME CLOCK|backend"
