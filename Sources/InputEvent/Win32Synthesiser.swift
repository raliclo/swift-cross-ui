    ...
    public final class Win32Synthesiser: Synthesiser, Sendable {
        ...
        private func isSmaller(_ inner: HWND, than outer: HWND) -> Bool {
            ...
            let innerArea = Int(innerRect.right - innerRect.left) *
                Int(innerRect.bottom - innerRect.top)
            let outerArea = Int(outerRect.right - outerRect.left) *
                Int(outerRect.bottom - outerRect.top)
        ...
        public func focusWindow(titled title: String) throws {
            ...
            guard
                ...
                throw SynthesiserError.toolFailed(
                    "SetWindowPos(HWND_TOPMOST) for focus '\(title)'",
                    status: Int32(GetLastError())
                )
            }
