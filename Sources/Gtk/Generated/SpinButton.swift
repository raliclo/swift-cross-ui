...
open class SpinButton: Widget, CellEditable, Editable, Orientable {
    ...
    open override func registerSignals() {
        ...
        addSignal(name: "delete-text", handler: gCallback(handler9)) { [weak self] (
            param0: Int,
            param1: Int
        ) in
            guard let self else { return }
        ...
        let handler10: @convention(c) (
            UnsafeMutableRawPointer, UnsafePointer<CChar>, Int, gpointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, value2, value3, data in
            SignalBox3<UnsafePointer<CChar>, Int, gpointer>.run(data, value1, value2, value3)
        }

        addSignal(name: "insert-text", handler: gCallback(handler10)) { [weak self] (
            param0: UnsafePointer<CChar>,
            param1: Int,
            param2: gpointer
        ) in
            guard let self else { return }
        ...
        addSignal(
            ...
            handler: gCallback(handler25)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifySelectionBound?(self, param0)
        }

        let handler26: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::text",
            handler: gCallback(handler26)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyText?(self, param0)
        }

        let handler27: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            ...
            handler: gCallback(handler27)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyWidthChars?(self, param0)
        }

        let handler28: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::xalign",
            handler: gCallback(handler28)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
            self.notifyXalign?(self, param0)
        }

        let handler29: @convention(c) (
            UnsafeMutableRawPointer, OpaquePointer, UnsafeMutableRawPointer
        ) -> Void = { _, value1, data in
            SignalBox1<OpaquePointer>.run(data, value1)
        }
        ...
        addSignal(
            name: "notify::orientation",
            handler: gCallback(handler29)
        ) { [weak self] (param0: OpaquePointer) in
            guard let self else { return }
