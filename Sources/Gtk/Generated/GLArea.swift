...
open class GLArea: Widget {
    ...
    open override func registerSignals() {
        ...
        addSignal(name: "resize", handler: gCallback(handler2)) { [weak self] (
            param0: Int,
            param1: Int
        ) in
            guard let self else { return }
        ...
        addSignal(
            name: "notify::has-stencil-buffer",
